...
import User from "../models/User3.model.js"; // Assuming you're importing the User model
import dotenv from "dotenv";
import {Validator3} from "../helper/Validator3.js";
...
export const registerUser = async (req, res) => {
  try {
    ...
    // Validate input data
    const validator = new Validator3();
